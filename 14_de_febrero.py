...
obj.color("deep pink")
obj.goto(80, 0)
obj.write("¿Quieres ser mi \nSan Valentín?❤️", align = "center", font = ("Impact", 25, "normal")) 
...
def toggle_checkbox():
    ...
    if var.get() == 1:
        ...
        obj.penup()
        obj.goto(50,-60)
        obj.write("texto de ejemplo ", align = "center", font = ("Arial", 11, "bold")) 
        # Secret message
        ...
        obj.penup()
        obj.goto(0,-250)
        obj.write("Texto de ejemplo ", align = "center", font = ("Arial", 9, "bold")) 
